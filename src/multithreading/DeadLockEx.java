...
class Thread10 extends Thread{
  ...
  public void run() {
      ...
      System.out.println("Thread10 Попытка захватить монитор объекта ЛОК1");
      synchronized (DeadLockEx.lock1){
        System.out.println("Thread10: Монитор объекта ЛОК1 захвачен");
        System.out.println("Thread10 Попытка захватить монитор объекта ЛОК2");
        synchronized (DeadLockEx.lock2){
          System.out.println("Thread10: Мониторы объектов ЛОК1 " +
              "и ЛОК2 захвачены");
